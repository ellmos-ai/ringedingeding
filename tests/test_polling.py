...
RINGING = {
    "status": "PREPARING",
    "transcript": None,
    "activity": ["17:37:45.146 | Call is ringing.", "17:37:49.509 | Call connected."],
}
TALKING = {
    "status": "PREPARING",
    "transcript": None,
    "activity": [
        ...
        "17:37:50.769 | Bot is speaking: Dies ist ein automatisierter Testanruf.",
...
DONE = {
    "status": "COMPLETED",
    "transcript": None,
    "activity": TALKING["activity"] + ["17:38:21.375 | Call ended."],
